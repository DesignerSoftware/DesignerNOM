...
public interface AdministrarCarpetaDesignerInterface {
   ...
   /**
    * Método encargado de recuperar todos los Modulos para la tabla 'Modulos' de
    * la pantalla.
    *
   ...
   /**
    * Método encargado de recuperar las tablas del sistema asociadas a un modulo
    * para la tabla 'Tablas del Sistema' de la Pantalla.
    *
   ...
   /**
    * Método encargado de recuperar una pantalla asociada a una tabla
    * específica.
    *
    ...
    * @return Retorna La Afición cuya secuencia coincide con el valor del
    * parámetro.
    */
    ...
    * Este método busca el mayor código registrado en la base de datos y le suma
    * 1 para sugerir un código consecutivo.
    *
