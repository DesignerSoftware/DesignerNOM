...
public class PersistenciaInterconInfor implements PersistenciaInterconInforInterface {
    ...
    public void crear(EntityManager em, InterconInfor interconSapBO) {
        ...
        try {
            ...
            System.out.println("Error PersistenciaInterconInfor.crear: " + e.toString());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void editar(EntityManager em, InterconInfor interconSapBO) {
        ...
        try {
            ...
            System.out.println("Error PersistenciaInterconInfor.editar: " + e.toString());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void borrar(EntityManager em, InterconInfor interconSapBO) {
        ...
        try {
            ...
            System.out.println("Error PersistenciaInterconInfor.borrar: " + e.toString());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public InterconInfor buscarInterconInforSecuencia(EntityManager em, BigInteger secuencia) {
        try {
            ...
            System.out.println("Error PersistenciaInterconInfor.buscarInterconInforSecuencia: " + e.toString());
            return null;
        }
    }
    ...
    public List<InterconInfor> buscarInterconInforParametroContable(EntityManager em, Date fechaInicial, Date fechaFinal) {
         try {
            ...
            System.out.println("Error PersistenciaInterconInfor.buscarInterconInforParametroContable: " + e.toString());
            return null;
        }
    }
    ...
    public Date obtenerFechaMaxInterconInfor(EntityManager em) {
        try {
            ...
            System.out.println("Error PersistenciaInterconInfor.obtenerFechaMaxInterconInfor: " + e.toString());
            return null;
        }
    }
    ...
    public void actualizarFlagProcesoAnularInterfaseContableInfor(EntityManager em, Date fechaIni, Date fechaFin) {
        ...
        try {
            ...
            System.out.println("Error PersistenciaInterconInfor.actualizarFlagProcesoAnularInterfaseContableInfor : " + e.toString());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void ejeuctarPKGUbicarnuevointercon_Infor(EntityManager em, BigInteger secuencia, Date fechaIni, Date fechaFin, BigInteger proceso) {
     em.clear();
        ...
        try {
            ...
            System.out.println("Error PersistenciaInterconInfor.ejeuctarPKGUbicarnuevointercon_InforV8 : " + e.toString());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void ejecutarDeleteInterconInfor(EntityManager em, Date fechaIni, Date fechaFin, BigInteger proceso) {
        ...
        try {
            ...
            System.out.println("Error PersistenciaInterconInfor.ejecutarDeleteInterconInforV8 : " + e.toString());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void cerrarProcesoLiquidacion(EntityManager em, Date fechaIni, Date fechaFin, BigInteger proceso) {
        ...
        try {
            ...
            System.out.println("Error PersistenciaInterconInfor.cerrarProcesoLiquidacion : " + e.toString());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void ejecutarPKGRecontabilizacion(EntityManager em, Date fechaIni, Date fechaFin) {
        ...
        try {
            ...
            System.out.println("Error PersistenciaInterconInfor.ejecutarPKGRecontabilizacion : " + e.toString());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public int contarProcesosContabilizadosInterconInfor(EntityManager em, Date fechaInicial, Date fechaFinal) {
         try {
            ...
            System.out.println("Error PersistenciaInterconInfor.contarProcesosContabilizadosInterconInfor. " + e.toString());
            return -1;
        }
    }
    ...
    public void ejecutarPKGCrearArchivoPlanoInfor(EntityManager em, Date fechaIni, Date fechaFin, BigInteger proceso, String descripcionProceso, String nombreArchivo) {
        ...
        try {
            ...
            System.out.println("Error PersistenciaInterconInfor.ejecutarPKGCrearArchivoPlanoSAPV8 : " + e.toString());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void actualizarFlagInterconInforProcesoDeshacer(EntityManager em, Date fechaInicial, Date fechaFinal, BigInteger proceso) {
        ...
        try {
            ...
            System.out.println("Error PersistenciaInterconInfor.actualizarFlagInterconSapBoProcesoDeshacer. " + e.toString());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void cerrarProcesoContabilizacion(EntityManager em, Date fechaInicial, Date fechaFinal, Short empresa, BigInteger proceso) {
        ...
        try {
            ...
            System.out.println("Error PersistenciaInterconInfor.cerrarProcesoContabilizacion. " + e.toString());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void eliminarInterconInfor(EntityManager em, Date fechaInicial, Date fechaFinal, Short empresa, BigInteger proceso) {
        ...
        try {
            ...
            System.out.println("Error PersistenciaInterconInfor.eliminarInterconSapBO. " + e.toString());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void actualizarFlagInterconInfor(EntityManager em, Date fechaInicial, Date fechaFinal, Short empresa) {
        ...
        try {
            ...
            System.out.println("Error PersistenciaInterconInfor.actualizarFlagInterconSapBO. " + e.toString());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
