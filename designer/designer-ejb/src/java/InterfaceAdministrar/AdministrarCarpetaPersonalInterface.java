...
public interface AdministrarCarpetaPersonalInterface {
   ...
   /**
    * Método encargado de recuperar la afiliación a salud actual de un empleado
    * específico.
    *
    * @param secEmpleado Secuencia del Empleado.
    * @return Retorna un VWActualesAfiliacionesSalud con la información
    * requerida.
    */
   public VWActualesAfiliacionesSalud consultarActualAfiliacionSaludEmpleado(BigInteger secEmpleado);

   /**
    * Método encargado de recuperar la afiliación a pensión actual de un
    * empleado específico.
    *
    * @param secEmpleado Secuencia del Empleado.
    * @return Retorna un VWActualesAfiliacionesPension con la información
    * requerida.
    */
   public VWActualesAfiliacionesPension consultarActualAfiliacionPensionEmpleado(BigInteger secEmpleado);

   /**
    * Método encargado de recuperar la localización actual de un empleado
    * específico.
    *
    * @param secEmpleado Secuencia del Empleado.
   ...
   /**
    * Método encargado de recuperar el tipo de trabajador actual de un empleado
    * específico.
    *
    * @param secEmpleado Secuencia del Empleado.
    * @return Retorna un VWActualesTiposTrabajadores con la información
    * requerida.
    */
   ...
   /**
    * Método encargado de recuperar el contrato actual de un empleado
    * específico.
    *
    * @param secEmpleado Secuencia del Empleado.
   ...
   /**
    * Método encargado de recuperar la reforma laboral actual aplicada a un
    * empleado específico.
    *
    * @param secEmpleado Secuencia del Empleado.
    * @return Retorna un VWActualesReformasLaborales con la información
    * requerida.
    */
   public VWActualesReformasLaborales consultarActualReformaLaboralEmpleado(BigInteger secEmpleado);

   /**
    * Método encargado de recuperar la Ubicación actual de un empleado
    * específico.
    *
    * @param secEmpleado Secuencia del Empleado.
   ...
   /**
    * Método encargado de recuperar la forma de pago actual para un empleado
    * específico.
    *
    * @param secEmpleado Secuencia del Empleado.
   ...
   /**
    * Método encargado de recuperar el tipo viajero actual de un empleado
    * específico.
    *
    * @param secEmpleado Secuencia del Empleado.
    * @return Retorna un VWActualesUbicaciones con la información requerida.
   ...
   /**
    * Método encargado de recuperar los empleados asociados con un
    * tipoTrabajador específico.
    *
    * @param tipo Tipo del trabajador por el cual se va a filtrar.
    * @return Retorna una lista de VWActualesTiposTrabajadores con la
    * informacion requerida.
    */
   public List<VwTiposEmpleados> consultarEmpleadosTipoTrabajador(String tipo);

   /**
    * Método encargado de recuperar la información de la empresa a la cual
   ...
   /**
    * Método encargado de recuperar el Usuario cuyo alias coincida con el dado
    * por parámetro.
    *
   ...
   /**
    * Método encargado de recuperar los Parametros Estructuras del Usuario
    * conectado.
    *
    * @return Retorna un ParametroEstructura, el cual esta asociado con el
    * usuario conectado.
    */
   public ParametrosEstructuras consultarParametrosUsuario();

   /**
    * Método encargado de recuperar las VigenciasCargos de un empleado
    * específico.
    *
    * @param secEmpleado Secuencia del Empleado.
    * @return Retorna una lista de VigenciasCargos asociadas al empleado cuya
   ...
   /**
    * Método encargado de recuperar los VWActualesTiposTrabajadores, para
    * obtener todos los empleados sin importar el tipo.
    *
    * @return Retorna una lista con todos los VWActualesTiposTrabajadores de la
    * vista.
    */
    ...
    * @return Retorna la persona cuya identificación coincide con el valor del
    * parámetro con el fin de recuperar la foto.
    */
    ...
    *
    * @param identificacion Identificación de la persona a la cual se le va a
    * actualizar la foto.
    */
    ...
    *
    * @param vigenciasCargos Lista de las VigenciasCargos que se van a
    * modificar.
    */
   public void editarVigenciasCargos(List<VigenciasCargos> vigenciasCargos);

   /**
    * Método encargado de recuperar el Alias del usuario que está conectado en
    * la sesión actual.
    *
    * @return Retorna un String con el Alias del usuario que esta conectado en
    * la sesion actual.
    */
   public String consultarAliasActualUsuario();

   /**
    * Método encargado de recuperar el estado actual de vacaciones de un
    * empleado específico.
    *
    * @param secEmpleado Secuencia del Empleado.
   ...
   /**
    * Método encargado de recuperar el estado actual MVR de un empleado
    * específico.
    *
    * @param secEmpleado Secuencia del Empleado.
    * @return Retorna un String con la información requerida.
