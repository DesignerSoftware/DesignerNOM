...
//    private EntityManager em;
   ...
   public void adicionaRetiroCambiosMasivos(EntityManager em, String indemniza, BigInteger secMotivoDefinitiva, BigInteger secMotivoRetiro, Date fechaCambio) {
      ...
      try {
         ...
         query.execute();
         System.out.println(this.getClass().getName() + ".adicionaRetiroCambiosMasivos() Ya ejecuto");
      } catch (Exception e) {
         System.err.println(this.getClass().getName() + ".adicionaRetiroCambiosMasivos() ERROR: " + e);
         e.printStackTrace();
         if (tx.isActive()) {
            tx.rollback();
         }
   ...
   public void undoAdicionaRetiroCambiosMasivos(EntityManager em, String indemniza, BigInteger secMotivoDefinitiva, BigInteger secMotivoRetiro, Date fechaCambio) {
      ...
      try {
         ...
         query.setParameter(4, fechaCambio);
         query.execute();
         System.out.println(this.getClass().getName() + ".undoAdicionaRetiroCambiosMasivos() Ya ejecuto");
      } catch (Exception e) {
         System.err.println(this.getClass().getName() + ".undoAdicionaRetiroCambiosMasivos() ERROR: " + e);
         e.printStackTrace();
         if (tx.isActive()) {
            tx.rollback();
         }
   ...
   public void adicionaReingresoCambiosMasivos(EntityManager em, Date fechaInicio, Date fechaFin) {
      ...
      try {
         ...
         query.execute();
         System.out.println(this.getClass().getName() + ".adicionaReingresoCambiosMasivos() Ya ejecuto");
      } catch (Exception e) {
         System.err.println(this.getClass().getName() + ".adicionaReingresoCambiosMasivos() ERROR: " + e);
         e.printStackTrace();
         if (tx.isActive()) {
            tx.rollback();
         }
