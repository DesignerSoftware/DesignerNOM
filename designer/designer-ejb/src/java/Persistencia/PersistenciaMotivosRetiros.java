...
//    private EntityManager em;
    ...
    public void crear(EntityManager em, MotivosRetiros motivosRetiros) {
        ...
        try {
            ...
            log.error("Error PersistenciaMotivosRetiros.crear:  ", e);
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void editar(EntityManager em, MotivosRetiros motivosRetiros) {
        ...
        try {
            ...
            log.error("Error PersistenciaMotivosRetiros.editar:  ", e);
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void borrar(EntityManager em, MotivosRetiros motivosRetiros) {
        ...
        try {
            ...
            log.error("Error PersistenciaMotivosRetiros.borrar:  ", e);
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public MotivosRetiros consultarMotivoRetiro(EntityManager em, BigInteger secuencia) {
        ...
        try {
            ...
            log.error("PersistenciaMotivosRetiros.consultarMotivoRetiro():  ", e);
    ...
    public BigInteger contarHVExperienciasLaboralesMotivoRetiro(EntityManager em, BigInteger secuencia) {
        ...
        try {
            ...
            log.error("Error PersistenciaMotivosRetiros   contarHVExperienciasLaboralesMotivoRetiro.  ", e);
            return retorno;
        }
    }
    ...
    public BigInteger contarNovedadesSistemasMotivoRetiro(EntityManager em, BigInteger secuencia) {
        ...
        try {
            ...
            log.error("Error PersistenciaMotivosRetiros   contarNovedadesSistemasMotivoRetiro.  ", e);
            return retorno;
        }
    }
    ...
    public BigInteger contarRetiMotivosRetirosMotivoRetiro(EntityManager em, BigInteger secuencia) {
        ...
        try {
            ...
            log.error("Error PersistenciaMotivosRetiros   contarRetiMotivosRetirosMotivoRetiro.  ", e);
            return retorno;
        }
    }
    ...
    public BigInteger contarRetiradosMotivoRetiro(EntityManager em, BigInteger secuencia) {
        ...
        try {
            ...
            log.error("Error PersistenciaMotivosRetiros   contarRetiRetiradosMotivoRetiro.  ", e);
            return retorno;
        }
    }
