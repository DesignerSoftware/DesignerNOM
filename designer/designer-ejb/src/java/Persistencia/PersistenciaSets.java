...
//    private EntityManager em;
    ...
    public boolean crear(EntityManager em, Sets sets) {
        ...
        try {
            ...
            System.out.println("Persistencia.PersistenciaSets.crear()" + e.getMessage());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void editar(EntityManager em, Sets sets) {
        ...
        try {
            ...
            System.out.println("Persistencia.PersistenciaSets.editar()" + e.getMessage());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void borrar(EntityManager em, Sets sets) {
        ...
        try {
            ...
            System.out.println("Persistencia.PersistenciaSets.borrar()" + e.getMessage());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public List<Sets> buscarSets(EntityManager em) {
        try {
            ...
            System.out.println("Persistencia.PersistenciaSets.buscarSets()" + e.getMessage());
            return null;
        }
    }
    ...
    public Sets buscarSetSecuencia(EntityManager em, BigInteger secuencia) {
        try {
            ...
            System.out.println("Persistencia.PersistenciaSets.buscarSetSecuencia() " + e.getMessage());
            return null;
        }
    }
    ...
    public List<Sets> buscarSetsEmpleado(EntityManager em, BigInteger secEmpleado) {
        try {
            ...
            System.out.println("Error en Persistencia Sets " + e.getMessage());
            return null;
        }
    }
}
