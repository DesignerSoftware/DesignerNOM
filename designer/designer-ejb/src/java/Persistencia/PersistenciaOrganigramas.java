...
//    private EntityManager em;
   ...
   public void crear(EntityManager em, Organigramas organigramas) {
      ...
      try {
         ...
         log.error("Error PersistenciaOrganigramas.crear:  ", e);
         if (tx.isActive()) {
            tx.rollback();
         }
      }
   ...
   public void editar(EntityManager em, Organigramas organigramas) {
      ...
      try {
         ...
         log.error("Error PersistenciaOrganigramas.editar:  ", e);
         if (tx.isActive()) {
            tx.rollback();
         }
      }
   ...
   public void borrar(EntityManager em, Organigramas organigramas) {
      ...
      try {
         ...
         log.error("Error PersistenciaOrganigramas.borrar:  ", e);
         if (tx.isActive()) {
            tx.rollback();
         }
      }
   ...
   public Organigramas buscarOrganigrama(EntityManager em, BigInteger secuencia) {
      try {
         ...
         log.error("PersistenciaOrganigramas.buscarOrganigrama():  ", e);
         return null;
      }
   }
   ...
   public List<Organigramas> buscarOrganigramas(EntityManager em) {
      try {
         log.warn("Si entro al EJB PersistenciaOrganigramas");
         em.clear();
         ...
         log.error("Error buscarOrganigramas PersistenciaOrganigramas :  ", e);
         return null;
      }
   }
   ...
   public List<Organigramas> buscarOrganigramasVigentes(EntityManager em, BigInteger secEmpresa, Date fechaVigencia) {
      try {
         ...
         log.error("PersistenciaOrganigramas.buscarOrganigramasVigentes():  ", e);
         return null;
      }
   }
   ...
   public List<Organigramas> buscarOrganigramasEmpresa(EntityManager em, BigInteger secEmpresa) {
      try {
         ...
         /*
             ...
             * listOrganigramas) { log.warn("organigrama : " +
             * organigrama); } }
          */
         log.warn("Otra empresa");
         return listOrganigramas;
      } catch (Exception e) {
         log.error("PersistenciaOrganigramas.buscarOrganigramasEmpresa():  ", e);
         return null;
      }
   }
   ...
   public Organigramas organigramaBaseArbol(EntityManager em, short codigoOrg) {
      try {
         ...
         log.error("Exepcion en organigramaBaseArbol  ", e);
         return null;
      }
   }
}
