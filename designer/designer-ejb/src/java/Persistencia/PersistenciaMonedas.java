...
//    private EntityManager em;
    ...
    public void crear(EntityManager em, Monedas monedas) {
        ...
        try {
            ...
            log.error("Error PersistenciaMonedas.crear:  ", e);
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void editar(EntityManager em, Monedas monedas) {
        ...
        try {
            ...
            log.error("Error PersistenciaMonedas.editar:  ", e);
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void borrar(EntityManager em, Monedas monedas) {
        ...
        try {
            ...
            log.error("Error PersistenciaMonedas.borrar:  ", e);
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public BigInteger contadorProyectos(EntityManager em, BigInteger secuencia) {
        ...
        try {
            ...
            log.error(" PersistenciaMonedas contadorIdiomasPersonas Error :  ", e);
            return retorno;
        }
    }
    ...
    public Monedas consultarMoneda(EntityManager em, BigInteger secuenciaTI) {
        try {
            ...
            log.error("PersistenciaMonedas.consultarMoneda():  ", e);
            return null;
        }
    }
    ...
    public List<Monedas> consultarMonedas(EntityManager em) {
        try {
            ...
            log.error("PersistenciaMonedas.consultarMonedas():  ", e);
            return null;
        }
    }
}
