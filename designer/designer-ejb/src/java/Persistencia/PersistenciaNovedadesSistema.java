    ...
    public String crear(EntityManager em, NovedadesSistema novedades) {
        ...
        try {
            ...
            if (e instanceof PersistenceException || e instanceof SQLIntegrityConstraintViolationException || e instanceof DatabaseException) {
                ...
                return "Ha ocurrido un error al Crear la novedad Sistema";
            }
        }
    }
    ...
    public String editar(EntityManager em, NovedadesSistema novedades) {
        ...
        try {
            ...
            if (e instanceof PersistenceException || e instanceof SQLIntegrityConstraintViolationException || e instanceof DatabaseException) {
                ...
                return "Ha ocurrido un error al Editar la novedad Sistema";
            }
        }
    }
    ...
    public String borrar(EntityManager em, NovedadesSistema novedades) {
        ...
        try {
            ...
            if (e instanceof PersistenceException || e instanceof SQLIntegrityConstraintViolationException || e instanceof DatabaseException) {
                ...
                return "Ha ocurrido un error al Borrar la novedad Sistema";
            }
        }
    }
