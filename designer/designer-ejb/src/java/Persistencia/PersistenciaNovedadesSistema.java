...
//    private EntityManager em;
    ...
    public void crear(EntityManager em, NovedadesSistema novedades) {
        System.out.println("Persistencia.PersistenciaNovedadesSistema.crear()");
        em.clear();
        ...
        try {
            ...
            System.out.println("Error PersistenciaNovedadesSistema.crear: " + e.getMessage());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void editar(EntityManager em, NovedadesSistema novedades) {
        ...
        try {
            ...
            System.out.println("Error PersistenciaNovedadesSistema.editar: " + e.getMessage());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public void borrar(EntityManager em, NovedadesSistema novedades) {
        ...
        try {
            ...
            System.out.println("Error PersistenciaNovedadesSistema.borrar: " + e.getMessage());
            if (tx.isActive()) {
                tx.rollback();
            }
        }
    ...
    public List<NovedadesSistema> novedadesEmpleado(EntityManager em, BigInteger secuenciaEmpleado) {
        try {
            ...
            System.out.println("Error: (novedadesEmpleado)" + e.getMessage());
            return null;
        }
    }
    ...
    public List<NovedadesSistema> novedadesEmpleadoCesantias(EntityManager em, BigInteger secuenciaEmpleado) {
        try {
            ...
            System.out.println("Error: (novedadesEmpleadoCesantias)" + e.getMessage());
            return null;
        }
    }
    ...
    public String buscarEstadoVacaciones(EntityManager em, BigInteger secuenciaEmpleado) {
        try {
            ...
            try {
                ...
                System.out.println("Persistencia.PersistenciaNovedadesSistema.buscarEstadoVacaciones()" + e.getMessage());
    ...
    public BigDecimal valorCesantias(EntityManager em, BigInteger secuenciaEmpleado) {
        ...
        try {
            ...
            System.out.println("entró al catch Error: (valorCesantias)" + e.getMessage());
    ...
    public BigDecimal valorIntCesantias(EntityManager em, BigInteger secuenciaEmpleado) {
        ...
        try {
            ...
            System.err.println("Error: (valorIntCesantias)" + e.getMessage());
    ...
    public BigDecimal consultarValorTotalDetalleVacacion(EntityManager em, BigInteger secNovedadSistema) {
        try {
            ...
            System.err.println("Error: consultarValorTotalDetalleVacacion : " + e.getMessage());
            return null;
        }
    }
    ...
    public void adicionaNovedadCambiosMasivos(EntityManager em,
        ...
        try {
            ...
            System.err.println(this.getClass().getName() + ".adicionaNovedadCambiosMasivos() ERROR: " + e.getMessage());
            e.printStackTrace();
            if (tx.isActive()) {
                tx.rollback();
            }
    ...
    public void undoAdicionaNovedadCambiosMasivos(EntityManager em,
        ...
        try {
            ...
            System.err.println(this.getClass().getName() + ".undoAdicionaNovedadCambiosMasivos() ERROR: " + e.getMessage());
            e.printStackTrace();
            if (tx.isActive()) {
                tx.rollback();
            }
