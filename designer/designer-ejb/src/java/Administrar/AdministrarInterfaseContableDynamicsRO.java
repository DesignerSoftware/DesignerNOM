...
public class AdministrarInterfaseContableDynamicsRO implements AdministrarInterfaseContableDynamicsROInterface {
   ...
   private static Logger log = Logger.getLogger(AdministrarInterfaseContableDynamicsRO.class);
   ...
   public int contarProcesosContabilizadosInterconDynamics(Date fechaInicial, Date fechaFinal) {
      try {
         int contador = persistenciaInterconDynamics.contarProcesosContabilizadosInterconDynamics(getEm(), fechaInicial, fechaFinal);
         return contador;
      } catch (Exception e) {
   ...
   public void ejecutarPKGCrearArchivoPlano(Date fechaIni, Date fechaFin, BigInteger proceso, String descripcionProceso, String nombreArchivo, BigDecimal emplDesde, BigDecimal emplHasta) {
      try {
         persistenciaInterconDynamics.ejecutarPKGCrearArchivoPlano(getEm(), fechaIni, fechaFin, proceso, descripcionProceso, nombreArchivo, emplDesde, emplHasta);
      } catch (Exception e) {
