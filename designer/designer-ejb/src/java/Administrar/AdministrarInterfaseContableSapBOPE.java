...
public class AdministrarInterfaseContableSapBOPE implements AdministrarInterfaseContableSapBOPEInterface {
   ...
   private static Logger log = Logger.getLogger(AdministrarInterfaseContableSapBOPE.class);
   ...
   public List<InterconSapBO> obtenerInterconSapBOPEParametroContable(Date fechaInicial, Date fechaFinal) {
      try {
         ...
         log.warn("Error obtenerInterconSapBOPEParametroContable Admi : " + e.toString());
         return null;
      }
   }
   ...
   public void actualizarFlagProcesoAnularInterfaseContableSAPBOPE(Date fechaIni, Date fechaFin) {
      try {
         ...
         log.warn("Error actualizarFlagProcesoAnularInterfaseContableSAPBOPE Admi : " + e.toString());
      }
   }
   ...
   public void cambiarFlagInterconContableSAPBOPE(Date fechaIni, Date fechaFin, BigInteger proceso) {
      try {
         ...
         log.warn("Error cambiarFlagInterconContableSAPBOPE Admi : " + e.toString());
      }
   }
   ...
   public void ejeuctarPKGUbicarnuevointercon_SAPBO_PE(BigInteger secuencia, Date fechaIni, Date fechaFin, BigInteger proceso) {
      try {
         persistenciaInterconSap.ejeuctarPKGUbicarnuevointercon_SAPBO_PE(getEm(), secuencia, fechaIni, fechaFin, proceso);
      } catch (Exception e) {
         log.warn("Error ejeuctarPKGUbicarnuevointercon_SAPBO_PE Admi : " + e.toString());
      }
   }
   ...
   public void ejecutarPKGCrearArchivoPlano(Date fechaIni, Date fechaFin, BigInteger proceso, String descripcion, String nombreArchivo) {
      try {
         persistenciaInterconSap.ejecutarPKGCrearArchivoPlanoSAPPE(getEm(), fechaIni, fechaFin, proceso, descripcion, nombreArchivo);
      } catch (Exception e) {
