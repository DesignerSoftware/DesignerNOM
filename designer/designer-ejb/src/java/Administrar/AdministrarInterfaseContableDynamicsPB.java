...
public class AdministrarInterfaseContableDynamicsPB implements AdministrarInterfaseContableDynamicsPBInterface {
   ...
   private static Logger log = Logger.getLogger(AdministrarInterfaseContableDynamicsPB.class);
   ...
   public void ejecutarPKGCrearArchivoPlano(Date fechaIni, Date fechaFin, BigInteger proceso, String descripcionProceso, String nombreArchivo, BigDecimal emplDesde, BigDecimal emplHasta) {
      try {
         persistenciaInterconDynamics.ejecutarPKGCrearArchivoPlano_PROLUB(getEm(), fechaIni, fechaFin, proceso, descripcionProceso, nombreArchivo, emplDesde, emplHasta);
      } catch (Exception e) {
   ...
   public void ejecutarPKGUbicarnuevointercon_DYNAMICS(BigInteger secuencia, Date fechaIni, Date fechaFin, BigInteger proceso, BigDecimal emplDesde, BigDecimal emplHasta) {
      try {
         persistenciaInterconDynamics.ejecutarPKGUbicarnuevointercon_PROLUB(getEm(), secuencia, fechaIni, fechaFin, proceso, emplDesde, emplHasta);
      } catch (Exception e) {
