...
public class AdministrarVigenciasDomiciliarias implements AdministrarVigenciasDomiciliariasInterface {
   ...
   public void borrarVigencia(List<VigenciasDomiciliarias> listaBorrar) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".borrarVigencia() ERROR: " + e);
      }
   }
   ...
   public List<VigenciasDomiciliarias> vigenciasDomiciliariasporPersona(BigInteger secPersona) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".vigenciasDomiciliariasporPersona() ERROR: " + e);
         return null;
      }
   }
   ...
   public List<EstadosCiviles> lovVigenciasEstadosCiviles() {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".lovVigenciasEstadosCiviles() ERROR: " + e);
         return null;
      }
   }
   ...
   public List<Direcciones> direccionesPersona(BigInteger secPersona) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".direccionesPersona() ERROR: " + e);
         return null;
      }
   }
   ...
   public Telefonos telefonoActualPersona(BigInteger secPersona) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".telefonoActualPersona() ERROR: " + e);
         return null;
      }
   }
   ...
   public VigenciasEstadosCiviles estadoCivilActualPersona(BigInteger secPersona) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".estadoCivilActualPersona() ERROR: " + e);
         return null;
      }
   }
   ...
   public List<Direcciones> consultarDireccionesPersona(BigInteger secPersona) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".consultarDireccionesPersona() ERROR: " + e);
         return null;
      }
   }
   ...
   public List<Telefonos> telefonosPersona(BigInteger secPersona) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".telefonosPersona() ERROR: " + e);
         return null;
      }
   }
   ...
   public void crearTelefonos(Telefonos telefono) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".crearTelefonos() ERROR: " + e);
      }
   }
   ...
   public void borrarTelefonos(Telefonos telefono) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".borrarTelefonos() ERROR: " + e);
      }
   }
   ...
   public void modificarTelefonos(List<Telefonos> listModificar) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".modificarTelefonos() ERROR: " + e);
      }
   }
   ...
   public List<VigenciasEstadosCiviles> estadosCivilesPersona(BigInteger secPersona) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".estadosCivilesPersona() ERROR: " + e);
         return null;
      }
   }
   ...
   public void modificarVigenciasEstadosCiviles(List<VigenciasEstadosCiviles> listaVigenciasEstadosCiviles) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".modificarVigenciasEstadosCiviles() ERROR: " + e);
      }
   }
   ...
   public void borrarVigenciasEstadosCiviles(List<VigenciasEstadosCiviles> listaVigenciasEstadosCiviles) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".borrarVigenciasEstadosCiviles() ERROR: " + e);
      }
   }
   ...
   public void crearVigenciasEstadosCiviles(List<VigenciasEstadosCiviles> listaVigenciasEstadosCiviles) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".crearVigenciasEstadosCiviles() ERROR: " + e);
      }
   }
...
/// métodos antecedentes médicos
   ...
   public List<SoAntecedentes> lovAntecedentes(BigInteger secTipoAntecedente) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".lovAntecedentes() ERROR: " + e);
         return null;
      }
   }
   ...
   public List<SoTiposAntecedentes> lovTiposAntecedentes() {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".lovTiposAntecedentes() ERROR: " + e);
         return null;
      }
   }
   ...
   public List<SoAntecedentesMedicos> buscarAntecedentesMedicos(BigInteger secPersona) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".buscarAntecedentesMedicos() ERROR: " + e);
         return null;
      }
   }
   ...
   public void crearAntecedenteM(List<SoAntecedentesMedicos> listaCrear) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".crearAntecedenteM() ERROR: " + e);
      }
   }
   ...
   public void borrarAntecedenteM(List<SoAntecedentesMedicos> listaBorrar) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".borrarAntecedenteM() ERROR: " + e);
      }
   }
   ...
   public void modificarAntecedenteM(List<SoAntecedentesMedicos> listaModificar) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".modificarAntecedenteM() ERROR: " + e);
      }
   }
   ...
   public List<AdiestramientosF> lovAdiestramientos() {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".lovAdiestramientos() ERROR: " + e);
         return null;
      }
   }
   ...
   public List<VigenciasFormales> vigenciasFormalesPersona(BigInteger secPersona) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".vigenciasFormalesPersona() ERROR: " + e);
         return null;
      }
   }
//////métodos exp laboral
   ...
   public HVHojasDeVida obtenerHojaVidaPersona(BigInteger secuencia) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".obtenerHojaVidaPersona() ERROR: " + e);
         return null;
      }
   }
   ...
   public List<HvExperienciasLaborales> experienciasLaboralesEmpleado(BigInteger secuencia) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".experienciasLaboralesEmpleado() ERROR: " + e);
         return null;
      }
   }
   ...
   public List<TiposFamiliares> lovTiposFamiliares() {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".lovTiposFamiliares() ERROR: " + e);
         return null;
      }
   }
   ...
   public List<Familiares> buscarFamiliares(BigInteger secPersona) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".buscarFamiliares() ERROR: " + e);
         return null;
      }
   }
   ...
   public VigenciasDomiciliarias vigenciaDomiciliariaActual(BigInteger secPersona) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".vigenciaDomiciliariaActual() ERROR: " + e);
         return null;
      }
   }
   ...
   public void editarHojadeVida(List<HVHojasDeVida> listaEditar) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".editarHojadeVida() ERROR: " + e);
      }
   }
   ...
   public void editarPersona(List<Personas> listaEditar) {
      try {
         ...
         log.error(this.getClass().getSimpleName() + ".editarPersona() ERROR: " + e);
      }
   }
