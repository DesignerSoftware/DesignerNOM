...
public class AdministrarInterfaseContableDynamicsMT implements AdministrarInterfaseContableDynamicsMTInterface {
   ...
   private static Logger log = Logger.getLogger(AdministrarInterfaseContableDynamicsMT.class);
   ...
   public void ejecutarPKGCrearArchivoPlano(Date fechaIni, Date fechaFin, BigInteger proceso, String descripcionProceso, String nombreArchivo, BigDecimal emplDesde, BigDecimal emplHasta) {
      try {
         persistenciaInterconDynamics.ejecutarPKGCrearArchivoPlano_MAMUT(getEm(), fechaIni, fechaFin, proceso, descripcionProceso, nombreArchivo, emplDesde, emplHasta);
      } catch (Exception e) {
   ...
   public void ejecutarPKGUbicarnuevointercon_DYNAMICS(BigInteger secuencia, Date fechaIni, Date fechaFin, BigInteger proceso, BigDecimal emplDesde, BigDecimal emplHasta) {
      try {
         persistenciaInterconDynamics.ejecutarPKGUbicarnuevointercon_MAMUT(getEm(), secuencia, fechaIni, fechaFin, proceso, emplDesde, emplHasta);
      } catch (Exception e) {
