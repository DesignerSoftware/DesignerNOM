 ...
 */
@Entity
@Table(name = "PLANTILLASVALIDATC")
public class PlantillasValidaTC implements Serializable {
    ...
    public PlantillasValidaTC() {
    }

    public PlantillasValidaTC(BigInteger secuencia, TiposTrabajadores tipotrabajador, TiposContratos tipocontrato) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlantillasValidaTC)) {
            return false;
        }
        PlantillasValidaTC other = (PlantillasValidaTC) object;
    ...
    public String toString() {
        return "Entidades.PlantillasValidaTC[ secuencia=" + secuencia + " ]";
    }
