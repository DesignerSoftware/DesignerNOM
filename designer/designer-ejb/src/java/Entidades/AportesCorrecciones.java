 ...
 */
@Entity
@Table(name = "APORTESCORRECCIONES")
public class AportesCorrecciones implements Serializable {
    ...
    public AportesCorrecciones() {
    }

    public AportesCorrecciones(BigInteger secuencia) {
        this.secuencia = secuencia;
    }

    public AportesCorrecciones(BigInteger secuencia, short ano, short mes) {
        this.secuencia = secuencia;
        this.ano = ano;
        this.mes = mes;
    }
...
//        System.out.println("entró a set bing : " + bing);
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AportesCorrecciones)) {
            return false;
        }
        AportesCorrecciones other = (AportesCorrecciones) object;
