...
@Entity
@Cacheable(false)
public class ParametrosAux implements Serializable {
   ...
   public boolean equals(Object object) {
      ...
      if (!(object instanceof ParametrosAux)) {
         return false;
      }
      ParametrosAux other = (ParametrosAux) object;
   ...
   public String toString() {
      return "Entidades.ParametrosAux[ id=" + secuencia + " ]";
   }
