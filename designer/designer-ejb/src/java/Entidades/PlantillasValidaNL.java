 ...
 */
@Entity
@Table(name = "PLANTILLASVALIDANL")
public class PlantillasValidaNL implements Serializable {
    ...
    public PlantillasValidaNL() {
    }

    public PlantillasValidaNL(BigInteger secuencia, TiposTrabajadores tipotrabajador, NormasLaborales normalaboral) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlantillasValidaNL)) {
            return false;
        }
        PlantillasValidaNL other = (PlantillasValidaNL) object;
    ...
    public String toString() {
        return "Entidades.PlantillasValidaNL[ secuencia=" + secuencia + " ]";
    }
