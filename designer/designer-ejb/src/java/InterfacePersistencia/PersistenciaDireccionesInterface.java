 ...
 * tabla 'Direcciones' de la base de datos.
 *
 * @author betelgeuse
 */
public interface PersistenciaDireccionesInterface {
    ...
    /**
     * Método encargado de modificar una Dirección de la base de datos. Este
    ...
    /**
     * Método encargado de eliminar de la base de datos la Dirección que entra
     * por parámetro.
     *
    ...
    /**
     * Método encargado de buscar la Dirección con la secuencia dada por
     * parámetro.
     *
     * @param secuencia Identificador único de la Dirección que se quiere
     * encontrar.
     * @return Retorna la Dirección identificada con la secuencia dada por
     * parámetro.
     */
    public Direcciones buscarDireccion(EntityManager em, BigInteger secuencia);

    /**
     * Método encargado de buscar todas las Direcciones existentes en la base de
     * datos.
     *
    ...
    /**
     * Método encargado de buscar las Direcciones con ultima fecha vigente,
     * existentes en la base de datos y asociadas a una persona.
     *
     * @param secuenciaPersona Secuencia de la persona de la que se quiere saber
     * la(s) dirección(es)
     * @return Retorna una lista de Direcciones
     */
    ...
    /**
     * Método encargado de buscar las Direcciones asociadas a una persona,
