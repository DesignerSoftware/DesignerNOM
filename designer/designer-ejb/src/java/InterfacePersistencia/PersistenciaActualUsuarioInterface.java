 ...
 * tabla 'ActualUsuario' de la base de datos.
 *
 * @author betelgeuse
 */
public interface PersistenciaActualUsuarioInterface {
   ...
   /**
    * Método encargado de consultar toda la información del usuario que está
   ...
   /**
    * Método encargado de consultar el alias del usuario que está usando el
    * aplicativo.
    *
   ...
   /**
    * Método encargado de consultar el alias del usuario que está usando el
    * aplicativo dado el EntityManager, es decir definiendo sobre cual base de
    * datos se busca la información.
    *
