 ...
 * tabla 'Inforeportes' (EntityManager em, Para esta interface las busquedas son
 * operaciones sobre la tabla UsuariosInfoReportes) de la base de datos.
 *
 * @author AndresPineda
 */
public interface PersistenciaInforeportesInterface {
    ...
    /**
     * Método encargado de modificar un Inforeporte de la base de datos. Este
    ...
    /**
     * Método encargado de buscar todos los Inforeportes existentes en la base
     * de datos.
     *
    ...
    /**
     * Método encargado de buscar los Inforeportes de Nomina permitidos para el
    ...
    /**
     * Método encargado de buscar los Inforeportes de Laboral permitidos para el
     * usuario actualmente conectado.
     *
     * @return Retorna una lista de Inforeportes
     */
    ...
    /**
     * Método encargado de buscar los Inforeportes de Contabilidad permitidos
    ...
    /**
     * Método encargado de buscar los Inforeportes de Bienestar permitidos para
     * el usuario actualmente conectado.
     *
     * @param em
     * @return Retorna una lista de Inforeportes
