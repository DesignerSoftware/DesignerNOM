...
public interface PersistenciaConexionInicialInterface {
   ...
   /**
    * Método encargado de validar si el usuario existe y esta activo. El que
    * este activo No hace referencia al estado de la sesión
    *
    * @param eManager EntityManager encargado de realizar la conexión a la base
    * de datos.
   ...
   /**
    * Método encargado de crear el EntityManager para comunicarse con la base de
    * datos.
    *
    * @param emf EntityManagerFactory que contiene la propiedades de conexión a
    * la base de datos.
   ...
   /**
    * Método encargado de recuperar la informacion del Rol y contraseña del Rol
    * de un perfil especifico.
    *
    * @param eManager EntityManager encargado las operaciones en la base de
    * datos.
   ...
   /**
    * Método encargado de recuperar la Secuencia del perfil al que el usuario
    * esta asociado.
    *
    * @param eManager EntityManager encargado las operaciones en la base de
    * datos.
    ...
    * @param eManager EntityManager encargado las operaciones en la base de
    * datos.
    * @param rol Rol del usuarios que esta conectándose. (información almacenada
    * en la base de datos)
    * @param pwd Contraseña del Rol. (información almacenada en la base de
    * datos)
    */
    ...
    * @return Retorna el número de entidades modificadas o eliminadas, o el
    * codigo del error encontrado.
    */
