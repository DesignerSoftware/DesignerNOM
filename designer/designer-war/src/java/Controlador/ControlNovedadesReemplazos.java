...
public class ControlNovedadesReemplazos implements Serializable {
    ...
    public void activarCtrlF11() {
        ...
        if (bandera == 0) {
            ...
            nREmpleadoReemplazado.setFilterStyle("width: 85%;");
