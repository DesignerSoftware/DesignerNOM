...
public class ControlTiposEmpresas implements Serializable {
    ...
    public void cancelarModificacion() {
        if (bandera == 1) {
            ...
            PrimefacesContextUI.actualizar("form:datosTiposEmpresas");
            bandera = 0;
    ...
    public void agregarNuevoTiposEmpresas() {
        ...
        if (contador == 2) {
            ...
            PrimefacesContextUI.ejecutar("PF('nuevoRegistroTiposEmpresas').hide()");
            index = -1;
            secRegistro = null;
    ...
    public void duplicandoTiposEmpresas() {
        ...
        if (index >= 0) {
            ...
            PrimefacesContextUI.ejecutar("PF('duplicarRegistroTiposEmpresas').show()");
            index = -1;
            secRegistro = null;
        }
    }
    ...
    public void confirmarDuplicar() {
        ...
        if (contador == 2) {
            ...
            duplicarTiposEmpresas = new TiposEmpresas();
            PrimefacesContextUI.ejecutar("PF('duplicarRegistroTiposEmpresas').hide()");
