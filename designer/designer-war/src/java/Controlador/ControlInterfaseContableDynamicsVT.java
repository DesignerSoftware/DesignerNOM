...
public class ControlInterfaseContableDynamicsVT implements Serializable {
   ...
   private static Logger log = Logger.getLogger(ControlInterfaseContableDynamicsVT.class);
   ...
   public void editarCelda() {
      ...
      if (indexParametroContable >= 0) {
         if (indexParametroContable == 0) {
            ...
            RequestContext.getCurrentInstance().update("formularioDialogos:editarDocAlternativoParametro");
            RequestContext.getCurrentInstance().execute("PF('editarDocAlternativoParametro').show()");
            indexParametroContable = -1;
      ...
      if (indexIntercon >= 0) {
         ...
         if (cualCeldaIntercon == 0) {
            ...
            RequestContext.getCurrentInstance().update("formularioDialogos:editarCargoIntercon");
            RequestContext.getCurrentInstance().execute("PF('editarCargoIntercon').show()");
            cualCeldaIntercon = -1;
         }
         indexIntercon = -1;
      }
   ...
   public void activarCtrlF11() {
      ...
      if (indexIntercon >= 0) {
         if (banderaIntercon == 0) {
            ...
            interCargo = (Column) c.getViewRoot().findComponent("form:datosIntercon:interCargo");
            interCargo.setFilterStyle("width: 85% !important;");
            RequestContext.getCurrentInstance().update("form:datosIntercon");
            banderaIntercon = 1;
