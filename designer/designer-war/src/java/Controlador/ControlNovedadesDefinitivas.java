...
//Ubicacion Celda Arriba 
                ...
                if (listaModificar != null) {
                    if (!listaModificar.isEmpty()) {
                        for (int n = 0; n < listaModificar.size(); n++) {
                            ...
                            msgError = administrarNovedadesSistema.modificarNovedades(listaModificar.get(n));
                        }
                ...
                if (listaCrear != null) {
                    if (!listaCrear.isEmpty()) {
                        for (int n = 0; n < listaCrear.size(); n++) {
                            msgError = administrarNovedadesSistema.crearNovedades(listaCrear.get(n));
                        }
                        listaCrear.clear();
                    }
                }
                if (listaBorrar != null) {
                    if (!listaBorrar.isEmpty()) {
                        for (int n = 0; n < listaBorrar.size(); n++) {
                            msgError = administrarNovedadesSistema.borrarNovedades(listaBorrar.get(n));
                        }
                        listaBorrar.clear();
                    }
                }
        ...
        if (listaEmpleados == null) {
            if (listasRecurrentes.getLovEmpleadosActPenc().isEmpty()) {
                ...
                if (listaEmpleados != null) {
                    ...
                    listasRecurrentes.setLovEmpleadosActPenc(listaEmpleados);
                }
            } else {
                listaEmpleados = new ArrayList<Empleados>(listasRecurrentes.getLovEmpleadosActPenc());
    ...
    public List<Empleados> getLovEmpleados() {
        if (lovEmpleados == null) {
            if (listasRecurrentes.getLovEmpleadosActPenc().isEmpty()) {
                lovEmpleados = administrarNovedadesSistema.buscarEmpleados();
                if (lovEmpleados != null) {
                    log.warn("GUARDANDO lovEmpleadosActPenc en Listas recurrentes");
