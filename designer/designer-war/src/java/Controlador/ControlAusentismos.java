...
//      cancelarModificacion();
   ...
   public void autocompletarFechas(Date fechaInicial, BigInteger dias, int tipo) {
      ...
      if (tipo == 1) {
         ...
         nuevoAusentismo.setFechainipago(fechaInicial);
         ...
         RequestContext.getCurrentInstance().update("formularioDialogos:nuevaFechaInicioPago");
         autocompletarFechapago(nuevoAusentismo.getFechainipago(), dias, 1);
      } else if (tipo == 2) {
         duplicarAusentismo.setFechafinaus(fechaH);
         duplicarAusentismo.setFechaexpedicion(fechaInicial);
         duplicarAusentismo.setFechainipago(fechaInicial);
         RequestContext.getCurrentInstance().update("formularioDialogos:duplicarFechaInicioPago");
         ...
         autocompletarFechapago(duplicarAusentismo.getFechainipago(), dias, 2);
      }
   }
