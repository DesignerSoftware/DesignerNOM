   ...
   public ParametrosReportes getParametroDeInforme() {
      try {
         if (parametroDeReporte == null) {
            ...
            if (parametroDeReporte == null) {
               log.info("Creando parametros para el usuario");
               parametroDeReporte = new ParametrosReportes();
               parametroDeReporte.setUsuario(administrarNReportesNomina.usuarioActual());
               parametroDeReporte.setCodigoempleadodesde(new BigDecimal(0));
               parametroDeReporte.setCodigoempleadohasta(new BigDecimal(999999999));
               parametroDeReporte.setFechadesde(new Date());
               parametroDeReporte.setFechahasta(new Date());
