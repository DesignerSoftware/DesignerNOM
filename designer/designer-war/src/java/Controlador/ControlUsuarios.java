...
public class ControlUsuarios implements Serializable {
    ...
    private String msgError, msgErrorAux, msgErrorGuardado;
        ...
        try {
            if (guardado == false) {
                ...
                if (!listaUsuariosBorrar.isEmpty()) {
                    for (int i = 0; i < listaUsuariosBorrar.size(); i++) {
                        if (listaUsuariosBorrar.get(i).getAlias().equals(null)) {
                            listaUsuariosBorrar.get(i).setAlias(null);
                        } else if (listaUsuariosBorrar.get(i).getPersona().getSecuencia() == null) {
                            listaUsuariosBorrar.get(i).setPersona(null);
                        } else if (listaUsuariosBorrar.get(i).getPerfil().getSecuencia() == null) {
                            listaUsuariosBorrar.get(i).setPerfil(null);
                        } else if (listaUsuariosBorrar.get(i).getPantallainicio().getSecuencia() == null) {
                            listaUsuariosBorrar.get(i).setPantallainicio(null);
                        }
                        msgErrorGuardado = administrarUsuario.borrarUsuarios(listaUsuariosBorrar.get(i));
                    }
                    listaUsuariosBorrar.clear();
                }
                if (!listaUsuariosCrear.isEmpty()) {
                    for (int i = 0; i < listaUsuariosCrear.size(); i++) {
                        if (listaUsuariosCrear.get(i).getAlias().equals(null)) {
                            listaUsuariosCrear.get(i).setAlias(null);
                        } else if (listaUsuariosCrear.get(i).getPersona().getSecuencia() == null) {
                            listaUsuariosCrear.get(i).setPersona(null);
                        } else if (listaUsuariosCrear.get(i).getPerfil().getSecuencia() == null) {
                            listaUsuariosCrear.get(i).setPerfil(null);
                        } else if (listaUsuariosCrear.get(i).getPantallainicio().getSecuencia() == null) {
                            listaUsuariosCrear.get(i).setPantallainicio(null);
                        }
                        msgErrorGuardado = administrarUsuario.crearUsuarios(listaUsuariosCrear.get(i));
                    }
                    listaUsuariosCrear.clear();
                }
                if (!listaUsuariosModificar.isEmpty()) {
                    for (int i = 0; i < listaUsuariosModificar.size(); i++) {
                        if (listaUsuariosModificar.get(i).getAlias().equals(null)) {
                            listaUsuariosModificar.get(i).setAlias(null);
                        } else if (listaUsuariosModificar.get(i).getPersona().getSecuencia() == null) {
                            listaUsuariosModificar.get(i).setPersona(null);
                        } else if (listaUsuariosModificar.get(i).getPerfil().getSecuencia() == null) {
                            listaUsuariosModificar.get(i).setPerfil(null);
                        } else if (listaUsuariosModificar.get(i).getPantallainicio().getSecuencia() == null) {
                            listaUsuariosModificar.get(i).setPantallainicio(null);
                        }
                        msgErrorGuardado = administrarUsuario.modificarUsuarios(listaUsuariosModificar.get(i));
                    }
                    listaUsuariosModificar.clear();
                }

                if (msgErrorGuardado.equals("EXITO")) {
                    listaUsuarios = null;
                    getListaUsuarios();
                    contarRegistros();
                    RequestContext.getCurrentInstance().update("form:datosUsuarios");
...
//                    generarArchivoReporte(jp);
    ...
    public String getMsgErrorGuardado() {
        return msgErrorGuardado;
    }

    public void setMsgErrorGuardado(String msgErrorGuardado) {
        this.msgErrorGuardado = msgErrorGuardado;
    }
}
