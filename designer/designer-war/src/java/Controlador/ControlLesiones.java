...
public class ControlLesiones implements Serializable {
    ...
    public void cancelarModificacion() {
        ...
        if (bandera == 1) {
            ...
            PrimefacesContextUI.actualizar("form:datosLesiones");
            bandera = 0;
    ...
    public void agregarNuevoLesiones() {
        ...
        if (contador == 2) {
            ...
            PrimefacesContextUI.ejecutar("PF('nuevoRegistroLesiones').hide()");
            index = -1;
            secRegistro = null;
    ...
    public void duplicandoLesiones() {
        ...
        if (index >= 0) {
            ...
            PrimefacesContextUI.ejecutar("PF('duplicarRegistroLesiones').show()");
            index = -1;
            secRegistro = null;
        }
    }
    ...
    public void confirmarDuplicar() {
        ...
        if (contador == 2) {
            ...
            duplicarLesiones = new Lesiones();
            PrimefacesContextUI.ejecutar("PF('duplicarRegistroLesiones').hide()");
