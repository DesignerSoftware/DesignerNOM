...
public class ControlJornadas implements Serializable {
   ...
   private static Logger log = Logger.getLogger(ControlJornadas.class);
...
//           ControlRastro controlRastro = (ControlRastro) fc.getApplication().evaluateExpressionGet(fc, "#{controlRastro}", ControlRastro.class);
   ...
   public void eventoFiltrar() {
      try {
         ...
         log.warn("Error ControlJornadas eventoFiltrar ERROR===" + e.getMessage());
      }
   }
   ...
   public void verificarBorrado() {
      ...
      try {
         if (jornadaSeleccionada != null) {
            log.error("Control Secuencia de ControlJornadas ");
   ...
   public void guardarJornadas() {
      if (guardado == false) {
         log.info("Realizando guardarJornadas");
