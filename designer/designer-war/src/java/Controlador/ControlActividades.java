...
public class ControlActividades implements Serializable {
    ...
    public void cancelarModificacion() {
        if (bandera == 1) {
            ...
            PrimefacesContextUI.actualizar("form:datosActividades");
            bandera = 0;
    ...
    public void agregarNuevoActividades() {
        ...
        if (contador == 2) {
            ...
            PrimefacesContextUI.ejecutar("PF('nuevoRegistroActividades').hide()");
            index = -1;
            secRegistro = null;
    ...
    public void duplicandoActividades() {
        ...
        if (index >= 0) {
            ...
            PrimefacesContextUI.ejecutar("PF('duplicarRegistroActividades').show()");
            index = -1;
            secRegistro = null;
        }
    }
