...
public class ControlProyecto implements Serializable {
    ...
    //PryClientes
    private List<PryClientes> lovPryClientes;
    private PryClientes clienteSeleccionado;
    private List<PryClientes> filtrarLovPryClientes;
    //PryPlataformas
    private List<PryPlataformas> lovPryPlataformas;
    private PryPlataformas plataformaSeleccionada;
    private List<PryPlataformas> filtrarLovPryPlataformas;
    //Monedas
    ...
    public void autocompletarNuevoyDuplicadoProyecto(String confirmarCambio, String valorConfirmar, int tipoNuevo) {
        ...
        if (confirmarCambio.equalsIgnoreCase("EMPRESAS")) {
            if (!valorConfirmar.isEmpty()) {
                ...
                if (coincidencias == 1) {
                    if (tipoNuevo == 1) {
                        nuevaProyectos.setEmpresa(lovEmpresas.get(indiceUnicoElemento));
                        RequestContext.getCurrentInstance().update("formularioDialogos:nuevaEmpresaP");
                    } else if (tipoNuevo == 2) {
                        duplicarProyecto.setEmpresa(lovEmpresas.get(indiceUnicoElemento));
            ...
            if (!valorConfirmar.isEmpty()) {
                ...
                for (int i = 0; i < lovPryClientes.size(); i++) {
                    if (lovPryClientes.get(i).getNombre().startsWith(valorConfirmar.toUpperCase())) {
                        indiceUnicoElemento = i;
                        coincidencias++;
                    }
                }
                ...
                if (coincidencias == 1) {
                    if (tipoNuevo == 1) {
                        nuevaProyectos.setPryCliente(lovPryClientes.get(indiceUnicoElemento));
                        RequestContext.getCurrentInstance().update("formularioDialogos:nuevaClienteP");
                    } else if (tipoNuevo == 2) {
                        duplicarProyecto.setPryCliente(lovPryClientes.get(indiceUnicoElemento));
            ...
            if (!valorConfirmar.isEmpty()) {
                ...
                for (int i = 0; i < lovPryPlataformas.size(); i++) {
                    if (lovPryPlataformas.get(i).getDescripcion().startsWith(valorConfirmar.toUpperCase())) {
                        indiceUnicoElemento = i;
                        coincidencias++;
                    }
                }
                if (coincidencias == 1) {
                    if (tipoNuevo == 1) {
                        nuevaProyectos.setPryPlataforma(lovPryPlataformas.get(indiceUnicoElemento));
                        RequestContext.getCurrentInstance().update("formularioDialogos:nuevaPlataformaP");
                    } else {
                        duplicarProyecto.setPryPlataforma(lovPryPlataformas.get(indiceUnicoElemento));
                        RequestContext.getCurrentInstance().update("formularioDialogos:duplicarPlataformaP");
                    }
                    lovPryPlataformas = null;
                    getLovPryPlataformas();
                } else {
            ...
            if (!valorConfirmar.isEmpty()) {
                ...
                if (coincidencias == 1) {
                    if (tipoNuevo == 1) {
                        nuevaProyectos.setTipomoneda(lovMonedas.get(indiceUnicoElemento));
                        RequestContext.getCurrentInstance().update("formularioDialogos:nuevaMonedaP");
                    } else if (tipoNuevo == 2) {
                        duplicarProyecto.setTipomoneda(lovMonedas.get(indiceUnicoElemento));
...
//    }
    ...
    public void setLovEmpresas(List<Empresas> setListEmpresas) {
        this.lovEmpresas = setListEmpresas;
    }
    ...
    public void setFiltrarLovEmpresas(List<Empresas> setFiltrarListEmpresas) {
        this.filtrarLovEmpresas = setFiltrarListEmpresas;
    }

    public List<PryClientes> getLovPryClientes() {
        try {
    ...
    public void setLovPryClientes(List<PryClientes> setListPryClientes) {
        this.lovPryClientes = setListPryClientes;
    }
    ...
    public List<PryClientes> getFiltrarLovPryClientes() {
        return filtrarLovPryClientes;
    }

    public void setFiltrarLovPryClientes(List<PryClientes> setFiltrarListPryClientes) {
        this.filtrarLovPryClientes = setFiltrarListPryClientes;
    }
    ...
    public List<PryPlataformas> getLovPryPlataformas() {
        try {
    ...
    public void setLovPryPlataformas(List<PryPlataformas> setListPryPlataformas) {
        this.lovPryPlataformas = setListPryPlataformas;
    }
    ...
    public List<PryPlataformas> getFiltrarLovPryPlataformas() {
        return filtrarLovPryPlataformas;
    }

    public void setFiltrarLovPryPlataformas(List<PryPlataformas> setFiltrarListPryPlataformas) {
        this.filtrarLovPryPlataformas = setFiltrarListPryPlataformas;
    }

    public List<Monedas> getLovMonedas() {
        lovMonedas = administrarProyectos.listMonedas();
        return lovMonedas;
    }

    public void setLovMonedas(List<Monedas> lovMonedas) {
        this.lovMonedas = lovMonedas;
    }
    ...
    public void setFiltrarLovMonedas(List<Monedas> filtrarLovMonedas) {
        this.filtrarLovMonedas = filtrarLovMonedas;
    }
