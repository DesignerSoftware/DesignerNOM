...
//         }
         ...
         if (coincidencias == 1) {
            if (tipoNuevo == 1) {
               ...
               duplicarFamiliar.getPersonafamiliar().setCiudadDocumento(lovCiudades.get(indiceUnicoElemento).getSecuencia());
               duplicarFamiliar.getPersonafamiliar().setNombreCiudadDocumento(lovCiudades.get(indiceUnicoElemento).getNombre());
...
//         }
         ...
         if (coincidencias == 1) {
            if (tipoNuevo == 1) {
               ...
               duplicarFamiliar.getPersonafamiliar().setCiudadNacimiento(lovCiudades.get(indiceUnicoElemento).getSecuencia());
               duplicarFamiliar.getPersonafamiliar().setNombreCiudadNacimiento(lovCiudades.get(indiceUnicoElemento).getNombre());
...
//         }
         ...
         if (coincidencias == 1) {
            if (tipoNuevo == 1) {
               ...
               duplicarFamiliar.getPersonafamiliar().setTipoDocumento(lovTiposDocumentos.get(indiceUnicoElemento).getSecuencia());
               duplicarFamiliar.getPersonafamiliar().setNombreTipoDocumento(lovTiposDocumentos.get(indiceUnicoElemento).getNombrelargo());
...
//                //mostrarBorrados
//                listVigenciaEstadoCivilBorrardddd
//            }
