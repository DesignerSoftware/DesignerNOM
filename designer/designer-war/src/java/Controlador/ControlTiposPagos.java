...
public class ControlTiposPagos implements Serializable {
    ...
    public void cancelarModificacion() {
        if (bandera == 1) {
            ...
            PrimefacesContextUI.actualizar("form:datosTiposPagos");
            bandera = 0;
    ...
    public void agregarNuevoTiposPagos() {
        ...
        if (contador == 2) {
            ...
            PrimefacesContextUI.ejecutar("PF('nuevoRegistroTiposPagos').hide()");
            index = -1;
            secRegistro = null;
    ...
    public void duplicandoTiposPagos() {
        ...
        if (index >= 0) {
            ...
            PrimefacesContextUI.ejecutar("PF('duplicarRegistroTiposPagos').show()");
            index = -1;
            secRegistro = null;
        }
    }
    ...
    public void confirmarDuplicar() {
        ...
        if (contador == 2) {
            ...
            duplicarTiposPagos = new Tipospagos();
            PrimefacesContextUI.ejecutar("PF('duplicarRegistroTiposPagos').hide()");
