...
public class ControlPartesCuerpo implements Serializable {
    ...
    public void cancelarModificacion() {
        if (bandera == 1) {
            ...
            PrimefacesContextUI.actualizar("form:datosPartesCuerpo");
            bandera = 0;
    ...
    public void agregarNuevoPartesCuerpo() {
        ...
        if (contador == 2) {
            ...
            PrimefacesContextUI.ejecutar("PF('nuevoRegistroPartesCuerpo').hide()");
            index = -1;
            secRegistro = null;
    ...
    public void duplicandoPartesCuerpo() {
        ...
        if (index >= 0) {
            ...
            PrimefacesContextUI.ejecutar("PF('duplicarRegistroPartesCuerpo').show()");
            index = -1;
            secRegistro = null;
        }
    }
    ...
    public void confirmarDuplicar() {
        ...
        if (contador == 2) {
            ...
            duplicarPartesCuerpo = new PartesCuerpo();
            PrimefacesContextUI.ejecutar("PF('duplicarRegistroPartesCuerpo').hide()");
