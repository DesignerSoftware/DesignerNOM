...
public class ControlPeriodicidades implements Serializable {
    ...
    private List<Unidades> filtradoLovUnidades;
...
//------------SETS Y GETS--------------------------------------**
    ...
    public List<Unidades> getLovUnidades() {
        if (lovUnidades == null) {
            lovUnidades = administrarPeriodicidades.consultarLOVUnidades();
        }
        return lovUnidades;
    }
    ...
    public List<Unidades> getFiltradoLovUnidades() {
        return filtradoLovUnidades;
    }

    public void setFiltradoLovUnidades(List<Unidades> filtradoLovUnidades) {
        this.filtradoLovUnidades = filtradoLovUnidades;
    }
