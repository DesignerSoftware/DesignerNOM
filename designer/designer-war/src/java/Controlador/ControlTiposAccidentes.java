...
public class ControlTiposAccidentes implements Serializable {
    ...
    public void cancelarModificacion() {
        if (bandera == 1) {
            ...
            PrimefacesContextUI.actualizar("form:datosTiposAccidentes");
            bandera = 0;
    ...
    public void agregarNuevoTiposAccidentes() {
        ...
        if (contador == 2) {
            ...
            PrimefacesContextUI.ejecutar("PF('nuevoRegistroTiposAccidentes').hide()");
            index = -1;
            secRegistro = null;
    ...
    public void duplicandoTiposAccidentes() {
        ...
        if (index >= 0) {
            ...
            PrimefacesContextUI.ejecutar("PF('duplicarRegistroTiposAccidentes').show()");
            index = -1;
            secRegistro = null;
        }
    }
    ...
    public void confirmarDuplicar() {
        ...
        if (contador == 2) {
            ...
            duplicarTiposAccidentes = new TiposAccidentes();
            PrimefacesContextUI.ejecutar("PF('duplicarRegistroTiposAccidentes').hide()");
