...
//   private List<VWDSolucionesNodosN> totalesEstadisticasLB;
    ...
    private List<Conceptos> lovConceptosEspecificos;
    private List<Conceptos> filtradoConceptos;
    private Conceptos conceptoSeleccionado;
    private Map<String, String> conjuntoC, conjuntoCSelect;
    private String parametroConjunto;
    //Conteo de Registros
    private int bandera;
    ...
    public ControlParametrosConjuntos() {
        ...
        lovConceptosEspecificos = new ArrayList<Conceptos>();
        ...
        cualCelda = -1;
        descripcionDetalle = " ";
        conjuntoCSelect = new LinkedHashMap<String, String>();
...
//           ControlRastro controlRastro = (ControlRastro) fc.getApplication().evaluateExpressionGet(fc, "#{controlRastro}", ControlRastro.class);
    ...
    public void rellenarMapConjuntos() {
        conjuntoCSelect.clear();
        if (parametrosActuales != null) {
            conjuntoCSelect.put("Conjunto 45 Sin conjunto: " + parametrosActuales.getTituloConjunto45(), "CONJUNTO45");
            conjuntoCSelect.put("Conjunto 1 Pago: " + parametrosActuales.getTituloConjunto1(), "CONJUNTO1");
            conjuntoCSelect.put("Conjunto 2 Pago: " + parametrosActuales.getTituloConjunto2(), "CONJUNTO2");
            conjuntoCSelect.put("Conjunto 3 Pago: " + parametrosActuales.getTituloConjunto3(), "CONJUNTO3");
            conjuntoCSelect.put("Conjunto 4 Pago: " + parametrosActuales.getTituloConjunto4(), "CONJUNTO4");
            conjuntoCSelect.put("Conjunto 5 Pago: " + parametrosActuales.getTituloConjunto5(), "CONJUNTO5");
            conjuntoCSelect.put("Conjunto 6 Pago: " + parametrosActuales.getTituloConjunto6(), "CONJUNTO6");
            conjuntoCSelect.put("Conjunto 7 Pago: " + parametrosActuales.getTituloConjunto7(), "CONJUNTO7");
            conjuntoCSelect.put("Conjunto 8 Pago: " + parametrosActuales.getTituloConjunto8(), "CONJUNTO8");
            conjuntoCSelect.put("Conjunto 9 Pago: " + parametrosActuales.getTituloConjunto9(), "CONJUNTO9");
            conjuntoCSelect.put("Conjunto 10 Pago: " + parametrosActuales.getTituloConjunto10(), "CONJUNTO10");
            conjuntoCSelect.put("Conjunto 11 Pago: " + parametrosActuales.getTituloConjunto11(), "CONJUNTO11");
            conjuntoCSelect.put("Conjunto 12 Pago: " + parametrosActuales.getTituloConjunto12(), "CONJUNTO12");
            conjuntoCSelect.put("Conjunto 13 Pago: " + parametrosActuales.getTituloConjunto13(), "CONJUNTO13");
            conjuntoCSelect.put("Conjunto 14 Pago: " + parametrosActuales.getTituloConjunto14(), "CONJUNTO14");
            conjuntoCSelect.put("Conjunto 15 Pago: " + parametrosActuales.getTituloConjunto15(), "CONJUNTO15");
            conjuntoCSelect.put("Conjunto 16 Pago: " + parametrosActuales.getTituloConjunto16(), "CONJUNTO16");
            conjuntoCSelect.put("Conjunto 17 Pago: " + parametrosActuales.getTituloConjunto17(), "CONJUNTO17");
            conjuntoCSelect.put("Conjunto 18 Pago: " + parametrosActuales.getTituloConjunto18(), "CONJUNTO18");
            conjuntoCSelect.put("Conjunto 19 Pago: " + parametrosActuales.getTituloConjunto19(), "CONJUNTO19");
            conjuntoCSelect.put("Conjunto 20 Pago: " + parametrosActuales.getTituloConjunto20(), "CONJUNTO20");
            conjuntoCSelect.put("Conjunto 21 Descuento: " + parametrosActuales.getTituloConjunto21(), "CONJUNTO21");
            conjuntoCSelect.put("Conjunto 22 Descuento: " + parametrosActuales.getTituloConjunto22(), "CONJUNTO22");
            conjuntoCSelect.put("Conjunto 23 Descuento: " + parametrosActuales.getTituloConjunto23(), "CONJUNTO23");
            conjuntoCSelect.put("Conjunto 24 Descuento: " + parametrosActuales.getTituloConjunto24(), "CONJUNTO24");
            conjuntoCSelect.put("Conjunto 25 Descuento: " + parametrosActuales.getTituloConjunto25(), "CONJUNTO25");
            conjuntoCSelect.put("Conjunto 26 Descuento: " + parametrosActuales.getTituloConjunto26(), "CONJUNTO26");
            conjuntoCSelect.put("Conjunto 27 Descuento: " + parametrosActuales.getTituloConjunto27(), "CONJUNTO27");
            conjuntoCSelect.put("Conjunto 28 Descuento: " + parametrosActuales.getTituloConjunto28(), "CONJUNTO28");
            conjuntoCSelect.put("Conjunto 29 Descuento: " + parametrosActuales.getTituloConjunto29(), "CONJUNTO29");
            conjuntoCSelect.put("Conjunto 30 Descuento: " + parametrosActuales.getTituloConjunto30(), "CONJUNTO30");
            conjuntoCSelect.put("Conjunto 31 Gasto: " + parametrosActuales.getTituloConjunto31(), "CONJUNTO31");
            conjuntoCSelect.put("Conjunto 32 Gasto: " + parametrosActuales.getTituloConjunto32(), "CONJUNTO32");
            conjuntoCSelect.put("Conjunto 33 Gasto: " + parametrosActuales.getTituloConjunto33(), "CONJUNTO33");
            conjuntoCSelect.put("Conjunto 34 Gasto: " + parametrosActuales.getTituloConjunto34(), "CONJUNTO34");
            conjuntoCSelect.put("Conjunto 35 Gasto: " + parametrosActuales.getTituloConjunto35(), "CONJUNTO35");
            conjuntoCSelect.put("Conjunto 36 Gasto: " + parametrosActuales.getTituloConjunto36(), "CONJUNTO36");
            conjuntoCSelect.put("Conjunto 37 Gasto: " + parametrosActuales.getTituloConjunto37(), "CONJUNTO37");
            conjuntoCSelect.put("Conjunto 38 Pasivo: " + parametrosActuales.getTituloConjunto38(), "CONJUNTO38");
            conjuntoCSelect.put("Conjunto 39 Pasivo: " + parametrosActuales.getTituloConjunto39(), "CONJUNTO39");
            conjuntoCSelect.put("Conjunto 40 Pasivo: " + parametrosActuales.getTituloConjunto40(), "CONJUNTO40");
            conjuntoCSelect.put("Conjunto 41 Pasivo: " + parametrosActuales.getTituloConjunto41(), "CONJUNTO41");
...
//                    generarArchivoReporte(jp);
    ...
    public void modificarParametrosActuales() {
        ...
        rellenarMapConjuntos();
        RequestContext.getCurrentInstance().update("form:parametroRep");
        contarRegistrosLB();
        contarRegistros();
...
//      log.info("6");
    ...
    public void cargarConceptosEspecificos(Short nConjunto) {
        ...
        for (int i = 0; i < lovConceptos.size(); i++) {
            if (lovConceptos.get(i).getConjunto() != null) {
                if (lovConceptos.get(i).getConjunto().equals(nConjunto)) {
                    lovConceptosEspecificos.add(lovConceptos.get(i));
                }
            }
        }
    ...
    public void cargarListaConceptos() {
        if (lovConceptos.isEmpty()) {
            lovConceptos = administrarParametrosConjuntos.consultarConceptos();
        }
    }
...
//        log.info("seleccionPorcentajes() : " + seleccionPorcentajes);
    ...
    public List<Conceptos> getLovConceptosEspecificos() {
        return lovConceptosEspecificos;
    }

    public void setLovConceptosEspecificos(List<Conceptos> lovConceptosEspecificos) {
        this.lovConceptosEspecificos = lovConceptosEspecificos;
    }
    ...
    public Map<String, String> getConjuntoCSelect() {
        return conjuntoCSelect;
    }

    public void setConjuntoCSelect(Map<String, String> conjuntoCSelect) {
        this.conjuntoCSelect = conjuntoCSelect;
    }

    public String getParametroConjunto() {
        return parametroConjunto;
    }
