...
public class ControlNovedadesCorreccionAutoLiquidaciones implements Serializable {
   ...
   private static Logger log = Logger.getLogger(ControlNovedadesCorreccionAutoLiquidaciones.class);
    ...
    public void navegar(String pag) {
        ...
        String pagActual = "novedadcorreccionautol";
        if (pag.equals("atras")) {
            pag = paginaAnterior;
...
//        novedadSeleccionada = null;
        ...
        if (pasa == 0) {
            ...
            RequestContext.getCurrentInstance().execute("PF('validarNuevo').show()");
        }
...
//                getListaSucursales();
    ...
    public void verificarRastro() {
        ...
        } else if (administrarRastros.verificarHistoricosTabla("NOVEDADESCORRECCIONAUTOLIQUIDACION")) {
    ...
    public void eventoFiltrarEmpresas() {
        modificarInfoRegistroEmpresas(lovEmpresasFiltrar.size());
    }

    public void eventoFiltrarTerceros() {
        modificarInfoRegistroTerceros(lovTercerosFiltrar.size());
    }

    public void eventoFiltrarSucursales() {
        modificarInfoRegistroSucursales(lovSucursalesFiltrar.size());
    }

    public void eventoFiltrarTiposEntidades() {
        modificarInfoRegistroTipoEntidad(lovTiposEntidadesFiltrar.size());
    }
    ...
    public List<TiposEntidades> getLovTiposEntidades() {
        if (lovTiposEntidades == null) {
            ...
            modificarInfoRegistroTipoEntidad(lovTiposEntidades.size());
        }
    ...
    public List<Terceros> getLovTerceros() {
        if (lovTerceros == null) {
            ...
            modificarInfoRegistroTerceros(lovTerceros.size());
        }
        return lovTerceros;
    }
    ...
    public List<SucursalesPila> getLovSucursales() {
        ...
        if (lovSucursales == null) {
            ...
            modificarInfoRegistroSucursales(lovSucursales.size());
        }
