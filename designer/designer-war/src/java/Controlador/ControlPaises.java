...
public class ControlPaises implements Serializable {
    ...
    public void cancelarModificacion() {
        if (bandera == 1) {
            ...
            PrimefacesContextUI.actualizar("form:datosPaises");
            bandera = 0;
            filtrarPaises = null;
            tipoLista = 0;
            tamano = 270;
    ...
    public void agregarNuevoPaises() {
        ...
        if (contador == 2) {
            ...
            PrimefacesContextUI.ejecutar("PF('nuevoRegistroPaises').hide()");
            index = -1;
            secRegistro = null;
    ...
    public void duplicandoPaises() {
        ...
        if (index >= 0) {
            ...
            PrimefacesContextUI.ejecutar("PF('duplicarRegistroPaises').show()");
            index = -1;
            secRegistro = null;
        }
    }
    ...
    public void confirmarDuplicar() {
        ...
        if (contador == 2) {
            ...
            duplicarPaises = new Paises();
            PrimefacesContextUI.ejecutar("PF('duplicarRegistroPaises').hide()");
