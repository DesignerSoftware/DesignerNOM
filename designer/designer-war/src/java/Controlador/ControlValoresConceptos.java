...
public class ControlValoresConceptos implements Serializable {
    ...
    public void cancelarModificacion() {
        if (bandera == 1) {
            ...
            PrimefacesContextUI.actualizar("form:datosValoresConceptos");
            bandera = 0;
    ...
    public void agregarNuevoValoresConceptos() {
        ...
        if (contador == 2 && contarValoresConceptos.equals(new BigInteger("0"))) {
            ...
            PrimefacesContextUI.ejecutar("PF('nuevoRegistroValoresConceptos').hide()");
            index = -1;
            secRegistro = null;
            cambioValoresConceptos = true;
    ...
    public void cargarNuevoValoresConceptos() {
        ...
        duplicarValoresConceptos.setConcepto(new Conceptos());
        RequestContext context = RequestContext.getCurrentInstance();
        PrimefacesContextUI.ejecutar("PF('nuevoRegistroValoresConceptos').show()");
    ...
    public void duplicandoValoresConceptos() {
        ...
        if (index >= 0) {
            ...
            PrimefacesContextUI.ejecutar("PF('duplicarRegistroValoresConceptos').show()");
            secRegistro = null;
        }
    }
    ...
    public void confirmarDuplicar() {
        ...
        if (contador == 2 && contarConceptosOperandos.equals(new BigInteger("0"))) {
            ...
            PrimefacesContextUI.ejecutar("PF('duplicarRegistroValoresConceptos').hide()");
            index = -1;
        } else {
