...
public class ControlGruposTiposEntidades implements Serializable {
   ...
   private static Logger log = Logger.getLogger(ControlGruposTiposEntidades.class);
   ...
   public void recibirPaginaEntrante(String pagina) {
      ...
      if (listGruposTiposEntidades != null) {
         if (!listGruposTiposEntidades.isEmpty()) {
            grupoTipoEntidadSeleccionado = listGruposTiposEntidades.get(0);
         }
      }
   ...
   public void navegar(String pag) {
      ...
      String pagActual = "grupotipoentidad";
      if (pag.equals("atras")) {
         pag = paginaAnterior;
