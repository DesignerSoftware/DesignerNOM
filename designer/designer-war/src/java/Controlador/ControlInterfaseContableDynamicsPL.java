...
public class ControlInterfaseContableDynamicsPL implements Serializable {
   ...
   private static Logger log = Logger.getLogger(ControlInterfaseContableDynamicsPL.class);
   ...
   public void navegar(String pag) {
      ...
      String pagActual = "interfasecontabledynamicspl";
      if (pag.equals("atras")) {
         pag = paginaAnterior;
...
//           ControlRastro controlRastro = (ControlRastro) fc.getApplication().evaluateExpressionGet(fc, "#{controlRastro}", ControlRastro.class);
   ...
   public void cambiarIndiceParametro(int indice) {
      ...
      if (permitirIndexParametro == true) {
         ...
         log.info("indexParametroContable : " + indexParametroContable);
      }
   }
   ...
   public void actionBtnProcDatos() {
      try {
         ...
         log.warn("Error actionBtnProcDatos Controlador : " + e.toString());
   ...
   public void editarCelda() {
      ...
      if (indexParametroContable >= 0) {
         if (indexParametroContable == 0) {
            ...
            RequestContext.getCurrentInstance().update("formularioDialogos:editarDocContableIntercon");
            RequestContext.getCurrentInstance().execute("PF('editarDocContableIntercon').show()");
            indexParametroContable = -1;
      ...
      if (indexIntercon >= 0) {
         ...
         if (cualCeldaIntercon == 0) {
            ...
            RequestContext.getCurrentInstance().update("formularioDialogos:editarFechaContaIntercon");
            RequestContext.getCurrentInstance().execute("PF('editarFechaContaIntercon').show()");
            cualCeldaIntercon = -1;
         } else if (cualCeldaIntercon == 10) {
            RequestContext.getCurrentInstance().update("formularioDialogos:editarRadicacionInternaIntercon");
            RequestContext.getCurrentInstance().execute("PF('editarRadicacionInternaIntercon').show()");
            cualCeldaIntercon = -1;
   ...
   public void activarCtrlF11() {
      ...
      if (indexIntercon >= 0) {
         if (banderaIntercon == 0) {
            ...
            interFechaContabilizacion = (Column) c.getViewRoot().findComponent("form:datosIntercon:interFechaContabilizacion");
            interFechaContabilizacion.setFilterStyle("width: 85% !important;");
            interRadicacion = (Column) c.getViewRoot().findComponent("form:datosIntercon:interRadicacion");
            interRadicacion.setFilterStyle("width: 85% !important;");
            interCodAlternativo = (Column) c.getViewRoot().findComponent("form:datosIntercon:interCodAlternativo");
